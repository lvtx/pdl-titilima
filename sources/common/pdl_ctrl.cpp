...
{
    return (int)SendMessageA(CB_FINDSTRINGEXACT, nStartAfter, (LPARAM)lpszString);
}

int LComboBox::FindString(__in int nStartAfter, __in PCWSTR lpszString)
{
    return (int)SendMessageW(CB_FINDSTRINGEXACT, nStartAfter, (LPARAM)lpszString);
}
...
int LListBox::FindString(__in int nStartAfter, __in PCSTR lpszItem)
{
    return static_cast<int>(
        SendMessageA(LB_FINDSTRINGEXACT, nStartAfter,
...
{
    return static_cast<int>(
        SendMessageW(LB_FINDSTRINGEXACT, nStartAfter,
        reinterpret_cast<LPARAM>(lpszItem)));
}
